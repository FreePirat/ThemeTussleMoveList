...
CREATE TABLE dbo.Move (
    ...
    HitBoxSizeX     INT          NOT NULL,
    HitBoxSizeY     INT          NOT NULL,
    HitBoxPosX      INT          NOT NULL,
    HitBoxPosY      INT          NOT NULL,
    HurtBoxSizeX    INT          NOT NULL,
    HurtBoxSizeY    INT          NOT NULL,
    HurtBoxPosX     INT          NOT NULL,
    HurtBoxPosY     INT          NOT NULL,
    Description     VARCHAR(255) NULL
);
...
INSERT INTO dbo.Move (CharacterId, InputName, Damage, StartupFrames, ActiveFrames, RecoveryFrames, OnBlock, HitBoxSizeX, HitBoxSizeY, HitBoxPosX, HitBoxPosY, HurtBoxSizeX, HurtBoxSizeY, HurtBoxPosX, HurtBoxPosY, Description)
VALUES (1,'5L', 20, 5,   5, 7,   -2,     100, 50,    60, -30, 160, 370, -40, 0,  'An average light poke'),
       ...
       (1,'8M', 24, 8,   4, 10,   0,     70,  70,    50,  40, 160, 300,   0, 0,  'An average light poke(HIGH BLOCK)'),
       (1,'8H', 38, 12,  4, 18,   0,     90,  105,   15,  15, 160, 300,   0, 0,  'An average light poke(HIGH BLOCK)');
